...
IF WEIGHT #999 ~IsGabber(Player1) !Global("ImoenRomanceActive","GLOBAL",3) !AreaCheck("AR5203") !ActuallyInCombat() !AreaCheck("AR5000") !AreaCheck("AR5203")~ NormalPID
  SAY @0
...
// ~~ Romantic interactions ~~
	...
	// Quality times
		...
		+ ~Global("ImoenRomanceActive","GLOBAL",2) IsGabber(Player1) Global("IRTQTPocket1","GLOBAL",1) Global("IRTQTPocket2","GLOBAL",0) AreaCheck("AR4500") Global("IRTSolarPresentTalk","GLOBAL",2)~ + @3 DO ~SetGlobal("IRTQTPocket2","GLOBAL",1) IncrementGlobal("IRTLoveMeter","GLOBAL",2)~ + 4QT
	...
	+ ~IsGabber(Player1) Global("ImoenRomanceActive","GLOBAL",2) RealGlobalTimerExpired("IRTPDATimer","GLOBAL") Global("IRTPDA","GLOBAL",7)~ + @25 DO ~IncrementGlobal("IRTPDA","GLOBAL",1) RealSetGlobalTimer("IRTPDATimer","GLOBAL",600)~ + PDA7-1
...
// ~~ Questions state leading to several conversations ~~
	...
	IF ~~ PIDQuestions
	  ...
	  /* Children */
       //after solar talk after killing senda and abazigal
	  + ~Global("IRTPregnancyTalk","GLOBAL",1) Gender(Player1, MALE)~ + @57 DO ~IncrementGlobal("IRTLoveMeter","GLOBAL",1) SetGlobal("IRTPregnancyTalk","GLOBAL",2)~ GOTO Preg1
