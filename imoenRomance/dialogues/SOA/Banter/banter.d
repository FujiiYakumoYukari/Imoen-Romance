...
/* Triggers only if all of the previous dialogs occurred, and after the sex scene: Global("MRSleptImoen","GLOBAL",1) and after her initial reaction to romance conclusion in PartyReactions */

CHAIN IF ~InParty("Jaheira")
	See("Jaheira")
	Global("MRSleptImoen","GLOBAL",1)
	Global("MRJaheiraReaction","GLOBAL",2)
	Global("MRJaheiraIncest","LOCALS",3)
	!StateCheck("Jaheira",CD_STATE_NOTVALID)
 !StateCheck(Myself,CD_STATE_NOTVALID)
