...
APPEND IMOEN2J
	...
	SAY @73
	 IF ~CheckStatGT(Player1,10,INT)~ THEN REPLY @74 GOTO MRResolutionAdmit
	 ++ @75 GOTO MRResolutionAlways
	 ++ @76 GOTO MRResolutionTease3
	 ++ @77  GOTO MRResolutionEnd
	 ++ @78 GOTO MRResolutionWhore
	END
...
APPEND IMOEN2J
	...
	IF ~~ THEN BEGIN MRResolution3Joke
	 SAY @207
	  IF ~CheckStatGT(Player1,9,INT)~ THEN REPLY @74 GOTO MRResolutionAdmit
	 ++ @75 GOTO MRResolutionAlways
	 ++ @76 GOTO MRResolutionTease3
	 ++ @77 GOTO MRResolutionEnd
	 ++ @78 GOTO MRResolutionWhore
	...
	IF ~~ THEN BEGIN MRResolutionBhaalThinkNonsense
	  SAY @286
	 IF ~CheckStatGT(Player1,8,INT)~ THEN REPLY @287 GOTO MRResolutionBhaalThinkLove
	 ++ @288 GOTO MRResolutionAlways
	 ++ @289 GOTO MRResolutionEnd
	 ++ @290 GOTO MRResolutionWhore
	END
